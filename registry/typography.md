...
- [ISO-9241-303] Ergonomics of human-system interaction — Requirements for
  ...
  Defines image quality requirements for electronic displays including character
  size, stroke width, character spacing, and luminance contrast. Specifies
  minimum legibility thresholds referenced by workplace and automotive display
  standards.
...
- [ISO-24751] Information technology — Individualized adaptability and
  ...
  Multi-part standard for adapting content presentation to individual needs.
  Covers font size, spacing, colour contrast, text-to-speech, and alternative
...
- [ISO-80000] Quantities and units
  ...
  Multi-part standard defining quantities, units, and symbols for use in science
  and engineering. Covers mechanics, thermodynamics, electricity, light,
  acoustics, information technology, and mathematics. The normative reference
...
- [SI] The International System of Units
  ...
  Defines the seven base units and their 2019 redefinitions based on fixed
  fundamental constants. The universal measurement system mandated by
