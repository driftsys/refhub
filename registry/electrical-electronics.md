...
- [IEC-60529] Degrees of protection provided by enclosures (IP Code)
  ...
  Defines the IP (Ingress Protection) rating system for electrical enclosures.
  First digit rates solid particle protection (0-6), second digit rates water
  ingress protection (0-9K). Referenced by every product standard requiring
...
- [IEC-60664] Insulation coordination for equipment within low-voltage supply
  ...
  Defines insulation coordination principles for equipment rated up to 1000V AC
  / 1500V DC. Specifies clearances, creepage distances, and solid insulation
  requirements based on pollution degree, overvoltage category, and altitude.
...
- [IEC-61131] Programmable controllers
  ...
  Multi-part standard for programmable logic controllers (PLCs). Part 3 defines
  five programming languages: Ladder Diagram (LD), Function Block Diagram (FBD),
  Structured Text (ST), Instruction List (IL), and Sequential Function Chart
...
- [IEC-61188] Printed boards and printed board assemblies — Design and use
  ...
  Defines design rules and requirements for printed board assemblies. Covers
  component land patterns, assembly processes, and design-for-manufacturing
...
- [IEC-61204] Low-voltage switch mode power supplies — DC output
  ...
  Defines safety and performance requirements for switch mode power supplies
  with DC output. Covers electrical, thermal, and EMC characteristics for power
...
- [IEC-62040] Uninterruptible power systems (UPS)
  ...
  Multi-part standard defining requirements for uninterruptible power systems.
  Covers general and safety requirements (-1), EMC requirements (-2), and
  performance and test methods (-3) for UPS protecting critical loads in data
...
- [LV-124] Electrical and Electronic Components in Motor Vehicles up to 3.5t —
  ...
  German automotive OEM standard (VW, BMW, Daimler, Porsche, Audi) defining
  environmental and electrical test requirements for vehicle components. Covers
  supply voltage, ESD, load dump, ground offset, and EMC pre-compliance testing.
...
- [LV-148] Electrical and Electronic Components in Motor Vehicles — 48V
  ...
  German automotive OEM standard extending LV 124 for 48V mild-hybrid vehicle
  electrical systems. Defines voltage ranges, transient conditions, and test
  requirements specific to 48V architectures increasingly adopted for
  electrification.
...
- [SAE-J3400] NACS — North American Charging Standard
  ...
  Defines the Tesla-originated charging connector and protocol adopted as the
  North American standard. Supports up to 1 MW charging with a single compact
  connector for both AC and DC. Adopted by major OEMs replacing CCS1 in North
  America.
