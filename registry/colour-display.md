...
- [CIE-15] Colorimetry
  ...
  Foundational publication defining the CIE colour measurement system. Specifies
  standard observers (2° and 10°), illuminants (D65, A, F), tristimulus values
  (XYZ), and derived colour spaces (xyY). The basis for all quantitative colour
...
- [IEC-61966-2-1] Colour measurement and management — Colour management —
  ...
  Defines the sRGB colour space used as the default for web, consumer displays,
  and digital imaging. Specifies chromaticity coordinates, transfer function
  (gamma ~2.2), and white point (D65). The universal assumption when no colour
  profile is embedded.
...
- [IEC-62341] Organic light emitting diode (OLED) displays
  ...
  Multi-part standard defining terminology, measurement methods, and performance
  requirements for OLED displays. Covers luminance uniformity, colour accuracy,
  lifetime, and burn-in characteristics specific to organic emissive display
  technology.
...
- [ISO-3664] Graphic technology and photography — Viewing conditions
  ...
  Defines standardised viewing conditions for evaluating colour reproductions in
  graphic arts and photography. Specifies illumination level (2000 lux for
  critical, 500 lux for practical), spectral quality (D50/D65), and surround
