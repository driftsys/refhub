...
- [ISO-6385] Ergonomics principles in the design of work systems
  ...
  Foundational standard for applying ergonomic principles to work system design.
  Covers task design, workspace layout, work environment, and equipment design
...
- [ISO-9241-110] Ergonomics of human-system interaction — Interaction principles
  ...
  Defines fundamental interaction principles for interactive systems:
  suitability for the task, self-descriptiveness, conformity with user
  expectations, learnability, controllability, robustness against user errors,
  and user engagement.
...
- [ISO-9241-210] Ergonomics of human-system interaction — Human-centred design
  ...
  Defines principles and activities for human-centred design throughout the
  lifecycle of interactive systems. Covers understanding context of use,
  specifying user requirements, producing design solutions, and evaluating
...
- [MIL-STD-1472] Human Engineering
  ...
  environmental conditions for military systems and equipment. Widely referenced
