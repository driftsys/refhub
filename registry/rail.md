...
- [EN-50126] Railway applications — The specification and demonstration of
  ...
  Defines the RAMS lifecycle for railway applications. Provides a systematic
  process for specifying and demonstrating reliability, availability,
  maintainability, and safety across all phases from concept to decommissioning.
...
- [EN-50128] Railway applications — Software for railway control and protection
  ...
  for railway control and protection systems. Specifies Software Safety
  Integrity Levels (SSIL 0-4) and required techniques at each level.
...
- [EN-50129] Railway applications — Communication, signalling and processing
  ...
  Defines requirements for the acceptance and approval of safety-related
  electronic systems for railway signalling. Specifies evidence required for
...
- [EN-50159] Railway applications — Communication, signalling and processing
  ...
  Defines requirements for safety-related communication in open and closed
  transmission systems. Specifies defences against message corruption,
  repetition, deletion, insertion, resequencing, and delay.
...
- [EN-50657] Railway applications — Rolling stock applications — Software on
  ...
  Software standard specifically for rolling stock applications. Covers on-board
  software for traction, braking, doors, passenger information, and other
  rolling stock subsystems. Complements EN 50128.
...
- [ERTMS-ETCS] European Rail Traffic Management System — European Train Control
  ...
  The European standard for train control and command. Defines three operational
  levels (1-3) providing continuous train supervision, movement authority
  management, and radio-based train spacing. Replaces national signalling
...
- [EU-2016-797] Directive on the interoperability of the rail system within the
  European Union

  EU directive establishing requirements for technical interoperability of the
  European rail system. Defines Technical Specifications for Interoperability
  (TSIs) covering rolling stock, infrastructure, energy, signalling, and
...
- [EU-2016-798] Directive on railway safety
  ...
  EU directive establishing a common framework for railway safety. Defines
  requirements for safety management systems, safety certification, safety
