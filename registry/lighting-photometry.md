...
- [CIE-S-025] Test Method for LED Lamps, LED Luminaires and LED Modules
  ...
  Defines photometric and colorimetric test methods for LED lighting products.
  Specifies measurement conditions, stabilisation procedures, and reporting
  requirements for luminous flux, efficacy, colour temperature, CRI, and spatial
  distribution.
...
- [IES-LM-79] Approved Method for Electrical and Photometric Measurements of
  ...
  IES standard defining test procedures for measuring total luminous flux,
  electrical power, efficacy, and chromaticity of complete LED luminaires and
  integral LED lamps. The primary test method referenced by ENERGY STAR and DLC
...
- [IES-LM-80] Approved Method for Measuring Luminous Flux and Colour Maintenance
  ...
  Defines the lumen maintenance test method for LED sources measuring luminous
  flux depreciation over a minimum 6,000 hours at controlled temperatures. Data
...
- [IES-TM-30] Method for Evaluating Light Source Colour Rendition
  ...
  Advanced colour rendition evaluation method replacing traditional CRI. Defines
  Fidelity Index (Rf), Gamut Index (Rg), and colour vector graphics using 99
  colour evaluation samples. Provides a more complete picture of how light
...
- [ISO-8995] Lighting of work places
  ...
  Defines lighting requirements for indoor work places. Specifies maintained
  illuminance levels, uniformity ratios, glare ratings (UGR), colour rendering
  indices, and flicker limits for office, industrial, healthcare, and
...
- [UN-R48] Uniform provisions concerning the approval of vehicles with regard to
  ...
  UN regulation defining requirements for the installation of all vehicle
  lighting: headlamps, position lamps, indicators, brake lamps, fog lamps, and
  daytime running lights. Specifies mounting positions, angles of visibility,
