...
Standards and protocols for system diagnostics, health monitoring, and fault
reporting. Covers automotive on-board diagnostics, network management protocols,
server hardware monitoring, and aerospace maintenance systems.
...
- [ARINC-615A] Software Data Loader Using Ethernet Interface
  ...
  Label: Standard\
  Keywords: avionics, software loading, LRU, Ethernet, aircraft, field-loadable
...
- [ARINC-624] Design Guidance for Onboard Maintenance System
  ...
  Label: Standard\
  Keywords: avionics, onboard maintenance, BITE, fault correlation,
  troubleshooting, aircraft diagnostics, OMS
...
- [ATA-iSpec-2200] Information Standards for Aviation Maintenance
  ...
  Label: Standard\
  Keywords: aviation maintenance, illustrated parts catalogue, wiring diagrams,
  MRO, aircraft documentation, troubleshooting
...
- [ISO-13209] Road vehicles — Open test sequence exchange (OTX)
  ...
  Label: Standard\
  Keywords: automotive diagnostics, OTX, test sequences, XML, diagnostic
  authoring, road vehicles
...
- [IPMI] Intelligent Platform Management Interface
  ...
  Label: Standard\
  Keywords: server management, BMC, hardware monitoring, sensor data, remote
  power control, data centre, out-of-band management
...
- [NETCONF] Network Configuration Protocol
  ...
  Label: Standard\
  Keywords: IETF, network configuration, XML, RPC, SSH, transactional
  management, rollback, NETCONF
...
- [OBD-II] On-Board Diagnostics II
  ...
  Label: Standard\
  Keywords: automotive diagnostics, OBD, DTC, PID, emissions, SAE J1962, vehicle
  self-diagnostics
...
- [Redfish] Redfish Scalable Platforms Management API
  ...
  Label: Standard\
  Keywords: DMTF, RESTful API, server management, firmware update, hardware
  monitoring, data centre, out-of-band management
...
- [SAE-J2534] Recommended Practice for Pass-Thru Vehicle Programming
  ...
  Label: Standard\
  Keywords: automotive diagnostics, ECU reprogramming, flash programming,
  pass-through, right-to-repair, vehicle programming
...
- [SNMP] Simple Network Management Protocol
  ...
  Label: Standard\
  Keywords: IETF, network monitoring, MIB, SNMP, trap notifications,
  infrastructure monitoring, enterprise, telecom
...
- [WWH-OBD] World-Wide Harmonized On-Board Diagnostics
  ...
  Label: Standard\
  Keywords: automotive diagnostics, OBD, UDS, CAN, IP transport, worldwide
  harmonization, remote monitoring
...
- [YANG] YANG Data Modeling Language
  ...
  Label: Standard\
  Keywords: IETF, data modelling, NETCONF, RESTCONF, SDN, network automation,
  YANG
